...
exports.LiveChatAIHandler2 = void 0;
...
const LiveChatAIHandler2 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        const { message, conversationId } = req.body;
        if (!message || typeof message !== "string") {
            return sendErrorResponse(res, 400, "Message is required and must be a string");
        }
        if (message.length > 1000) {
            return sendErrorResponse(res, 400, "Message exceeds 1000 character limit");
        }
...
exports.LiveChatAIHandler2 = LiveChatAIHandler2;
// Utilities
function getConversationHistory(conversationId) {
    var _a;
    if (!conversationId)
        return [];
    return ((_a = conversationHistory.get(conversationId)) === null || _a === void 0 ? void 0 : _a.slice(-10)) || [];
}
